...
class HT_CTC_Admin_Customize_Styles {
    ...
    public function settings() {
        ...
        // register_setting( 'ht_ctc_cs_page_settings_fields', 'ht_ctc_deprecated' , array( $this, 'options_sanitize' ) );
        // register_setting( 'ht_ctc_cs_page_settings_fields', 'ht_ctc_delete' , array( $this, 'options_sanitize' ) );
        ...
        // add_settings_field( 'ht_ctc_deprecated', 'Delete Settings', array( $this, 'ht_ctc_deprecated_cb' ), 'ht_ctc_cs_page_settings_sections_do', 'ht_ctc_cs_settings_sections_add' );
        // add_settings_field( 'ht_ctc_delete', 'Delete Settings', array( $this, 'ht_ctc_delete_cb' ), 'ht_ctc_cs_page_settings_sections_do', 'ht_ctc_cs_settings_sections_add' );
    ...
    function ht_ctc_delete_cb() {
        $options = get_option('ht_ctc_delete');
        ?>
        <ul class="collapsible" data-collapsible="accordion">
        <li>
        <div class="collapsible-header">Delete/clear settings</div>
        <div class="collapsible-body">

            <!-- Delete settings while plugin uninstall/delete -->
            <div class="row">
                <div class="col s6">
                    <p>Delete/clear settings</p>
                </div>
                <div class="input-field col s6">
                    <?php
                    if ( isset( $options['delete_options'] ) ) {
                        ...
                        <p>
                            <label>
                                <input name="ht_ctc_delete[delete_options]" type="checkbox" value="1" <?php checked( $options['delete_options'], 1 ); ?> id="delete_options"   />
                                <span>Delete settings while plugin uninstall/delete</span>
                            </label>
                        </p>
                        <?php
                    } else {
                        ...
                        <p>
                            <label>
                                <input name="ht_ctc_delete[delete_options]" type="checkbox" value="1" id="delete_options"   />
                                <span>Delete settings while plugin uninstall/delete</span>
                            </label>
                        </p>
                        <?php
            ...
            <p class="description">If checked, all the settings will be delete from the Database while uninstall the pluign</p>
