...
class HT_CTC_Chat_Shortcode {
    ...
    public function shortcode( $atts = [], $content = null, $shortcode = '' ) {
        ...
        if ( is_file( $sc_path ) ) {
            ...
            $img_link = plugins_url("./new/inc/assets/img/whatsapp-logo.png", HT_CTC_PLUGIN_FILE );
            ...
            $o .= '<img class="img-icon-sc sc_item pointer style-3-sc" src="'.$img_link.'" alt="WhatsApp chat" style="height: 36px; '.$css.' " >';
            $o .= '</div>';
        }
